...
namespace MauiApp2.DataGrid
{
    ...
    public sealed class DataGridColumn : BindableObject, IDefinition
    {
        ...
        public static readonly BindableProperty FilterEnabledProperty =
          BindableProperty.Create(nameof(FilterEnabled), typeof(bool), typeof(TextCell), true);
